...
public class FrameAlertSample extends StaticVariables {
	...
	public void f() throws Exception {
		...
		cfn.openURL("https://stqatools.com/demo/Frames.php");
//		cfn.loopAllFramesForElement(By.id("btnAlert"));
//		cfn.clickByAnyLocator(By.id("btnAlert"));
//		Thread.sleep(3000);
//		cfn.clickByAnyLocator(By.xpath("//button[contains(text(),'Ok')]"));
//		
		cfn.loopAllFramesForElement(By.id("btnConfirm"));
		cfn.clickByAnyLocator(By.id("btnConfirm"));
	...
	public void afterMethod() throws Exception {
		cfn.takeScreenshot("FrameAlertSample");
	}
