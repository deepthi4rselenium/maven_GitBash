...
public class DropDownSample extends StaticVariables {
	...
	public void f() throws Exception {
		...
		cfn.openURL("https://tirupatibalaji.ap.gov.in/#/registration");
		...
		//select the proof dropdown value based on the index
	...
	public void afterMethod() throws Exception {
		cfn.takeScreenshot("DropDownSample");
	}
